...
class StatsLayout(ui.LayoutView):
    ...
    def setup_team_content(self):
        ...
        self.container.add_item(ui.TextDisplay("Developer:\n- [gt4realz_](https://discord.com/users/783953632974471178)"))

        self.container.add_item(ui.TextDisplay("Owner:\n- [x12alt](https://discord.com/users/1430989005599805504)"))
...
class Stats(commands.Cog):
    ...
    async def stats(self, ctx):
        loading_container = ui.Container(
            ui.TextDisplay("<a:AcpXZ_loading:1373173756113195081> Loading acp.xz's information..."),
            accent_color=None
        )
