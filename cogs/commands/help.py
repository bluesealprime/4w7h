...
# Global constants
color = 0x000000
# Note: Redundant bot instance creation was removed from here.
            ...
            ui.Select(
                ...
                options=[
                    ...
                    discord.SelectOption(
                        label="Welcomer",
                        value="welcomer",
                        description="Setup welcome and leave messages"
                    ),
                    discord.SelectOption(
                        label="Security",
                        value="security",
                        description="Manage server safety and antinuke"
                    ),
                    discord.SelectOption(
                        label="AI",
                        value="ai",
                        description="Chat with advanced AI personalities"
                    ),
                    discord.SelectOption(
                        label="Automod",
                        value="automod",
                        description="Auto-moderation and word blacklists"
                    ),
                    discord.SelectOption(
                        label="Backup",
                        value="backup",
                        description="Create and load server backups"
                    ),
                    discord.SelectOption(
                        label="Counting",
                        value="counting",
                        description="Fun counting games and leaderboards"
                    ),
                    discord.SelectOption(
                        label="Utility",
                        value="utility",
                        description="Useful tools and info commands"
                    ),
                    discord.SelectOption(
                        label="Fun",
                        value="fun",
                        description="Bored? Try some fun activities"
                    ),
                    discord.SelectOption(
                        label="Giveaway",
                        value="giveaway",
                    ...
                    discord.SelectOption(
                        label="Tickets",
                        value="tickets",
                        description="Professional ticket support system"
                    ),
                    discord.SelectOption(
                        label="Leveling",
                        value="leveling",
                        description="Member engagement and XP system"
                    ),
                    discord.SelectOption(
                        label="Bot GuildProfile",
                        value="guildprofile",
                        description="Server identity and customization"
                    ),
                    discord.SelectOption(
                        label="Crypto",
                        value="crypto",
            ...
            ui.Select(
                ...
                options=[
                    ...
                    discord.SelectOption(
                        label="Voice",
                        value="voice",
                        description="Voice channel management tools"
                    ),
                    discord.SelectOption(
                        label="Ignore",
                        value="ignore",
                        description="Manage ignored users and channels"
                    ),
                    discord.SelectOption(
                        label="StickyNotes",
                        value="stickynotes",
                        description="Post persistent messages"
                    ),
                    discord.SelectOption(
                        label="General",
                        value="general",
                    ...
                    discord.SelectOption(
                        label="Tracking",
                        value="tracking",
                        description="Audit user invites and messages"
                    ),
                    discord.SelectOption(
                        label="Server",
                        value="server",
                    ...
                    discord.SelectOption(
                        ...
                        value="pfps",
                        description="Get avatar and banner images"
                    ),
                    discord.SelectOption(
                        label="ToDo",
                        value="todo",
